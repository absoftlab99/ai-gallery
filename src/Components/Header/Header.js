...
const Header = () => {
    ...
    const menu = (
        <>
            <li>
                <Link to={"/"}>
                    <BsBroadcastPin className=""></BsBroadcastPin>Discover
                </Link>
            </li>
            {user ? (
                <>
                    <li>
                        <Link to={"/bookmark"}>
                            <BsBookmark></BsBookmark>Bookmarks
                        </Link>
                    </li>
                    <li>
                        <Link to={"/myGallery"}>
                            <BsFillGridFill></BsFillGridFill>My Gallery
                        </Link>
                    </li>
                    <li>
                        <Link to={"/addAi"}>
                            <BsPlusLg></BsPlusLg>Add New Ai Tool
                        </Link>
                    </li>
                </>
            ) : (
            ...
            <div className="navbar-end">
                {user ? (
                    <button onClick={signOutHandler} className="btn">
                        <FcRedo className="text-2xl mr-2"></FcRedo> Logout
                    </button>
                ) : (
                    <button onClick={googleSingIn} className="btn">
                        <FcGoogle className="text-2xl mr-2"></FcGoogle> Sign In
                    </button>
                )}
            </div>
        </div>
